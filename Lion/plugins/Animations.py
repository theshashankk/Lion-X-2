...
@Lion.on(admin_cmd(pattern="stupid$"))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"bombs$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"kills$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern="ding$"))
async def _(event):
    ...
    animation_chars = [
            ...
            "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
            "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
	    "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [CAT IS BEST](https://github.com/Sur-vivor/CatLion) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜"
...
@Lion.on(admin_cmd(pattern=f"hypno$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern="gangasta$"))
async def _(event):
...
@Lion.on(admin_cmd(pattern=f"charging$"))
...
@Lion.on(admin_cmd(pattern="ctext ?(.*)"))
async def payf(event):
    paytext=event.pattern_match.group(1)
...
@Lion.on(admin_cmd(pattern="ftext ?(.*)"))
async def payf(event):
    paytext=event.pattern_match.group(1)
...
@Lion.on(admin_cmd(outgoing=True, pattern="kf$(.*)"))
async def _(event):                             
...
@Lion.on(admin_cmd(pattern=f"square$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=f"up$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=f"round$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=f"hart$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"anim$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=f"fnl$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"monkey$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@Lion.on(admin_cmd(pattern=f"herber$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@Lion.on(admin_cmd(pattern=f"hand$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=f"gsg$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=r"theart$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=r"fdance"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=f"snake$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=f"human$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Lion.on(admin_cmd(pattern=f"mc$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern="virus$"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=r"repe$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"isro$"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=f"nakal$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Lion.on(admin_cmd(pattern=f"music$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=f"squ$",outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=r"star$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🦋✨🦋✨🦋✨🦋✨"))
...
@Lion.on(admin_cmd(pattern=r"boxs"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🟥🟧🟨🟩🟦🟪🟫⬛⬜"))
...
@Lion.on(admin_cmd(pattern=f"rain$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🌬☁️🌩🌨🌧🌦🌥⛅🌤"))
...
@Lion.on(admin_cmd(pattern=r"clol$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🤔🧐🤨🤔🧐🤨"))
...
@Lion.on(admin_cmd(pattern=r"odra$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🚶🏃🚶🏃🚶🏃🚶🏃"))
...
@Lion.on(admin_cmd(pattern=r"deploy$"))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern="dump ?(.*)"))
async def _(message):
    try:
...
@Lion.on(admin_cmd(pattern="fleaveme$"))
async def _(event):
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern="loveu", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@Lion.on(admin_cmd(pattern=f"plane", outgoing=True))
async def _(event):
    if event.fwd_from:
        retun
    await event.edit("✈-------------")
...
@Lion.on(admin_cmd(pattern=r"pulis"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@Lion.on(admin_cmd(pattern=f"jio$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@Lion.on(admin_cmd(pattern=f"solarsystem", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@Lion.on(admin_cmd(pattern=r"lul$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("😂🤣😂🤣😂🤣"))
...
@Lion.on(admin_cmd(pattern=r"nothappy$"))
async def _(event):
	if event.fwd_from:
		return
...
@Lion.on(admin_cmd(outgoing=True, pattern="clock$"))
async def _(event):
	    if event.fwd_from:
		    return
	    deq = deque(list("🕙🕘🕗🕖🕕🕔🕓🕒🕑🕐🕛"))
...
@Lion.on(admin_cmd(pattern=r"muah$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("😗😙😚😚😘"))
...
@Lion.on(admin_cmd(pattern="heart$"))		
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("❤️🧡💛💚💙💜🖤"))
...
@Lion.on(admin_cmd(pattern="gym$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🏃‍🏋‍🤸‍🏃‍🏋‍🤸‍🏃‍🏋‍🤸‍"))
...
@Lion.on(admin_cmd(pattern=f"earth$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
...
@Lion.on(admin_cmd(outgoing=True, pattern="moon$"))
async def _(event):
	    if event.fwd_from:
		    return
	    deq = deque(list("🌗🌘🌑🌒🌓🌔🌕🌖"))
...
@Lion.on(admin_cmd(pattern=r"candy$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🍦🍧🍩🍪🎂🍰🧁🍫🍬🍭"))
...
@Lion.on(admin_cmd(pattern=f"smoon$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@Lion.on(admin_cmd(pattern=f"tmoon$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@Lion.on(admin_cmd(pattern=f"clown$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Lion.on(admin_cmd(pattern=r"aheart$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
