...
from Lion.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@Lion.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@Lion.on(admin_cmd(pattern="snips (.*)"))
...
@Lion.on(admin_cmd(pattern="snipl"))
...
@Lion.on(admin_cmd(pattern=r"snipd (\S+)"))
